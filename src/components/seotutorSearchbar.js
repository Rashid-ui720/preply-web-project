...
class SeoSearchBar extends Component {
  state = {
    languagesLavel: [
      "Advanced ",
      "Upper intermediate ",
    ...
    return (
      <div className="w-100 pt-4  bp-10">
        <div className="d-flex align-items-center flex-column mb-5">
          <h4 className="text-uppercase">{city_data.page_title}</h4>
          <p className="font-size-3 col-md-8">
            <ShowMoreText
              lines={1}
              more="Read more"
              less="Read less"
