...
class trustedCurriculum extends Component {
  render() {
    return (
      <div>
        <section className="pb-lg-10 bg-default-2">
          <div className="container">
            {/* qualified tutor start */}
              ...
              <div className="col-12 col-md-12 col-lg-12 col-xxl-12">
                <div className="text-center mb-5 mb-lg-12 px-xl-9 px-xxl-7">
                  ...
                  <p className="font-size-3 text-default-color text-center px-xs-9 px-md-0 width-40P ml-auto mr-auto ">
                    Catering to the learning needs of 500 + pupils from all
                    around the world, our online Madrassa is trusted and
                    recommended. Together, our pupils and certified tutors,
                    build impacting Islamic journeys. Join our community today
                    and make your goals seem closer!
                  </p>
                  <Link
...
export default trustedCurriculum;
