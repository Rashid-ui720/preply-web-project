...
class FreeAppoinmentSuccess extends React.Component {
  state = {};
  render() {
    return (
      <div
                ...
                >
                  ...
                  <div className="404-texts pt-14">
                    ...
                    <p className="card-text font-size-4 px-xxl-28 px-xs-10 px-sm-13 px-lg-13 px-md-28 px-xl-22 px-0 mb-11">
                      This is a confirmation that you have just booked free appointment.
                    </p>
                    {/* <!-- card-texts end --> */}
                    <Link
...
export default FreeAppoinmentSuccess;
