...
class TutorChnagePassword extends React.Component {
  state = {
    password: "",
    old_password: "",
  };
          ...
          <div className="mb-15 mb-lg-23">
            <div className="row">
              <div className="col-xxxl-9 px-lg-13 px-6">
                <div className="bg-white h-100 px-11 pt-11 pb-7 rounded">
                  ...
                  <form onSubmit={this.handelResetPassword}>
                    ...
                    <div className="form-group mb-8 ">
                      <button
                        className="btn btn-primary btn-medium w-10 rounded-5 text-uppercase"
                        type="submit"
                      >
                        Change Password
                      </button>
...
export default connect(mapStateToProps, null)(TutorChnagePassword);
