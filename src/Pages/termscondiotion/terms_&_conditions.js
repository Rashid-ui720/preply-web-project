...
class term_condition extends Component {
  render() {
    return (
        ...
        <div className="container">
          <div className="row justify-content-center mt-14">
            <div className="col-xxl-6 col-xl-7 col-lg-8 mb-10">
              <h2 className="font-size-9 text-center">Terms & Conditions</h2>
              <p className="font-size-5 text-center">
                Quran Teacher Terms & Conditions
              </p>
            </div>
          </div>
          ...
          <div class="row justify-content-center">
            ...
            <div className="col-xxl-10 col-xl-10 col-lg-10 mb-10">
              <div class="bg-white px-9 pt-9 pb-7 shadow-8 rounded-4">
                <p className="font-size-3 text-justified">
                  ...
                  to it, still belong to Quran Teacher.
                </p>
                <p className="font-size-3 text-justified">
                  Quran Teacher is committed to ensuring that the app is as
                ...
                <p className="font-size-3 text-justified">
                  The Quran Teacher app stores and processes personal data that
                  ...
                  security features and it could mean that the Quran Teacher app
                ...
                <p className="font-size-3 text-justified">
                  ...
                  used by the app{" "}
                  <a href="https://policies.google.com/terms" class="">
                    [Google Play Services].
                  </a>
                </p>
                <p className="font-size-3 text-justified">
                  You should be aware that there are certain things that Quran
                  Teacher will not take responsibility for. Certain functions of
                  the app will require the app to have an active internet
                  connection. The connection can be Wi-Fi, or provided by your
                  mobile network provider, but Quran Teacher cannot take
                ...
                <p className="font-size-3 text-justified">
                  Along the same lines, Quran Teacher cannot always take
                  responsibility for the way you use the app i.e. You need to
                  make sure that your device stays charged – if it runs out of
                  battery and you can’t turn it on to avail the Service, Quran
                  Teacher cannot accept responsibility.
                </p>
                <p className="font-size-3 text-justified">
                  With respect to Quran Teacher’s responsibility for your use of
                  the app, when you’re using the app, it’s important to bear in
                  mind that although we endeavour to ensure that it is updated
                  and correct at all times, we do rely on third parties to
                  provide information to us so that we can make it available to
                  you. Quran Teacher accepts no liability for any loss, direct
                  or indirect, you experience as a result of relying wholly on
                ...
                <p className="font-size-3 text-justified">
                  ...
                  download the updates if you want to keep using the app. Quran
                  Teacher does not promise that it will always update the app so
                  that it is relevant to you and/or works with the Android
                ...
                <p className="font-size-5 font-weight-bold mb-2 mt-4 text-primary">
